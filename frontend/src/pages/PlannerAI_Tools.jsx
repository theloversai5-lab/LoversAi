    ...
    <>
      ...
      <div id="ai-tools-section" className="bg-black py-20 px-4">
        <div className="w-full px-[6%]">
          ...
          >
            {showRetexturing ? "← Back" : "Image Retexturing →"}
          </h2>
      ...
      <div className="bg-black py-20 px-4">
        <div className="w-full px-[6%] mt-16">
          ...
          >
            {showAngleChanger ? "← Back" : "Image Angle →"}
          </h2>
          ...
          <h2
            onClick={() =>
              handleToolClick("image-to-video", () => {
                // This could open another tool or show a message
                alert(
                  "Image to Video tool is currently in development. Coming soon!",
                );
              })
            }
            className="text-[64px] text-white mb-16 heading-font text-left cursor-pointer hover:text-rose-300 transition"
      ...
      <div id="subscriptions-section" className="bg-black py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-full px-[6%] flex justify-center mb-20">
