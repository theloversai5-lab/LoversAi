...
export default function PlannerMessages() {
  ...
  useEffect(() => {
    ...
    chatAPI.getMessages(activeRoom._id).then(res => {
          ...
          <div className="flex-1 overflow-y-auto">
            {loading ? (
              ...
              <div className="p-8 text-center text-white/30 text-sm">
                ...
                No conversations yet. Start chatting from the Bids page.
              </div>
            ) : rooms.map(room => {
        ...
        {activeRoom ? (
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {msgLoading ? (
                <div className="text-center text-white/30 py-8">Loading messages...</div>
              ) : messages.length === 0 ? (
                ...
                return (
                  <div key={m._id || i} className={`max-w-[80%] ${isMine ? 'ml-auto' : 'mr-auto'}`}>
                    ...
                    <p className={`text-[9px] text-white/15 mt-1 ${isMine ? 'text-right' : 'text-left'}`}>
            ...
            <div className="p-3 border-t border-white/5 flex gap-2">
              ...
              <button onClick={handleSend} disabled={!newMsg.trim()}
                className="loverai-btn-primary px-4 py-2.5 rounded-xl disabled:opacity-30 disabled:transform-none disabled:shadow-none">
